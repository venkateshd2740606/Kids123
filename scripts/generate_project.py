#!/usr/bin/env python3
"""Generate Kids123 Android project files."""
import os
from pathlib import Path

ROOT = Path(r"d:\Work\Games\Kids123")
APP = ROOT / "app"
MAIN = APP / "src" / "main"
JAVA = MAIN / "java" / "com" / "kids123"
TEST = APP / "src" / "test" / "java" / "com" / "kids123"
ANDROID_TEST = APP / "src" / "androidTest" / "java" / "com" / "kids123"
...
android {
    namespace = "com.kids123"
    compileSdk = 35

    defaultConfig {
        applicationId = "com.kids123.game"
        minSdk = 26
        targetSdk = 35
        versionCode = 1
        versionName = "1.0.0"
...
-keep class com.kids123.data.** { *; }
-keep class com.kids123.domain.model.** { *; }
...
files[APP / "google-services.json"] = '''{
  "project_info": {
    ...
    "project_id": "kids123-game",
    "storage_bucket": "kids123-game.firebasestorage.app"
  },
  "client": [{
    "client_info": {
      "mobilesdk_app_id": "1:000000000001:android:0000000000000000000001",
      "android_client_info": { "package_name": "com.kids123.game" }
    },
    "oauth_client": [],
...
if __name__ == "__main__":
    print("Generating Kids123 project files...")
